...
def kdry(phi: np.ndarray, ks: np.ndarray, ksatA: np.ndarray,
         kfluidA: np.ndarray) -> np.ndarray:
...
def ksat(phi: np.ndarray, ks: np.ndarray, kdry: np.ndarray,
         kfluidB: np.ndarray) -> np.ndarray:
...
def gassmann_subs(phi: np.ndarray, ks: np.ndarray, ksatA: np.ndarray,
                  kfluidA: np.ndarray,
                  kfluidB: np.ndarray) -> np.ndarray:
...
def gassmann(phi: np.ndarray, ks: np.ndarray,
