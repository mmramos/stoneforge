...
def density_porosity(rhob: np.ndarray, rhom: float, rhof: float) -> np.ndarray:
...
def neutron_porosity(nphi: np.ndarray, vsh: np.ndarray,
...
def neutron_density_porosity(phid: np.ndarray, phin: np.ndarray,
