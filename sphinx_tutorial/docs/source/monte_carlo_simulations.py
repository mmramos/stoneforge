...
def experimental_correlation(data: np.ndarray)-> np.ndarray:
  """
...
def experimental_variogram(data: np.ndarray, rho: np.ndarray)-> np.ndarray:
  """
...
def exponential_variogram_model(distance: np.ndarray, correlation_length: float, sill: float, nugget: float=0)-> np.ndarray:
  """
...
def gaussian_variogram_model(distance: np.ndarray, correlation_length: float, sill: float, nugget: float=0)-> np.ndarray:
  """
...
def spherical_variogram_model(distance: np.ndarray, correlation_length: float, sill: float, nugget: float=0)-> np.ndarray:
  """
...
def analytical_variogram(distance: np.ndarray, gama: np.ndarray, model:str="best-fit")-> np.ndarray:
  """
...
def modeled_correlation(gama: np.ndarray, var: float)-> np.ndarray:
  """
...
def cov_matrix(rho: np.ndarray, var: float)-> np.ndarray:
  """
...
def MCS_spacial_correlation(n: int, smooth_data: np.ndarray, cov: np.ndarray)-> np.ndarray:
  """
...
def MCS_correlated_variables(n: int, data1: np.ndarray, data2: np.ndarray,
                             smooth_data1: np.ndarray, smooth_data2: np.ndarray,
