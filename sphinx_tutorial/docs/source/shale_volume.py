...
def gammarayindex(gr: np.ndarray, grmin: float, grmax: float) -> np.ndarray:
...
def vshale_linear(gr: np.ndarray, grmin: float, grmax: float) -> np.ndarray:
...
def vshale_larionov_old(gr: np.ndarray, grmin: float, grmax: float) -> np.ndarray:
...
def vshale_larionov(gr: np.ndarray, grmin: float, grmax: float) -> np.ndarray:
...
def vshale_clavier(gr: np.ndarray, grmin: float, grmax: float):
...
def vshale_stieber(gr: np.ndarray, grmin: float, grmax: float):
...
def vshale_neu_den(neu: np.ndarray, den: np.ndarray, cl1_n: float,
...
def vshale(gr: np.ndarray, grmin: float, grmax: float, method: str = None) -> np.ndarray:
