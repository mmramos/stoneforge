...
def archie(rw: float, rt: np.ndarray, phi: np.ndarray, a: float,
...
def simandoux(rw: float, rt: np.ndarray, phi: np.ndarray, a: float,
              m: float, n: float, vsh: np.ndarray,
...
def indonesia(rw: float, rt: np.ndarray, phi: np.ndarray, a: float,
              m: float, n: float, vsh: np.ndarray,
              rsh: float) -> np.ndarray:
...
def fertl(rw: float, rt: np.ndarray, phi: np.ndarray, a: float,
          m: float, vsh: np.ndarray, alpha: float) -> np.ndarray:
...
def water_saturation(rw: float, rt: np.ndarray, phi: np.ndarray,
